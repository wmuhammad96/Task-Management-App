<template>
  <div class="p-6">
    ...
    <div v-for="task in showTaskUponUser" :key="task.id" class="grid grid-cols-6 border border-amber-100 bg-amber-100 text-amber-800  ">
...
console.log(showTaskUponUser.value)
