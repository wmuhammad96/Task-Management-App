<template>
    <section class="bg-[url('/image/bg.png')] bg-cover bg-center w-auto h-auto dark:bg-gray-900/90 transition min-h-screen">
        <div class="flex flex-col lg:flex-row h-full">
           
            <div class="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 order-2 lg:order-1">
                <div class="w-full max-w-md p-6 sm:p-8 rounded-xl backdrop-blur-sm bg-amber-50/80 dark:bg-gray-800/80 shadow-xl">
                    <h2 class="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 text-center text-amber-950 dark:text-gray-300">
                        Login Desk
                    </h2>
                    ...
                    <div class="mb-4 sm:mb-6">
                        ...
                        <input 
                            ...
                            v-model="email" 
                            id="email"
                            class="w-full border border-amber-300 dark:border-gray-600 rounded-lg px-4 py-2 sm:py-3 
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                        <button
                            type="submit"
                            @click.prevent="login"
                            class="w-full sm:w-auto rounded-lg bg-gradient-to-r from-amber-600 to-amber-950 dark:from-amber-700 dark:to-amber-900 
                        ...
                        <button
                            ...
                            class="w-full sm:w-auto rounded-lg bg-gradient-to-r from-amber-950 to-amber-600 dark:from-amber-900 dark:to-amber-700
                                   text-amber-100 px-4 sm:px-6 py-2 sm:py-3 text-lg sm:text-xl hover:opacity-90 transition-all shadow-md
                                   focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
                        >
                            Register
